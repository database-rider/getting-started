...
----
<1> We're creating the database from our JPA entities, but we could use a database migration tool like flyway to do this work, see https://github.com/database-rider/database-rider/blob/master/rider-examples/jOOQ-DBUnit-flyway-example/src/test/java/JooqDBUnitTest.java#L45[example here^].
