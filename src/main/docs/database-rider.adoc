= Ruling Database Testing with Database Rider
:page-layout: base
...
BDD and DBUnit are integrated by https://github.com/rmpestano/dbunit-rules#cucumber-module[Database Rider Cucumber^]. It's a https://cucumber.io/[Cucumber^] runner which is CDI aware.
...
NOTE: Living documentation of _Database Rider_ is based on its https://github.com/rmpestano/dbunit-rules/tree/master/cdi/src/test/java/com/github/dbunit/rules/bdd[BDD tests^], you can access it here: http://rmpestano.github.io/dbunit-rules/documentation.html.
